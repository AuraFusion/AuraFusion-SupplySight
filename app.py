...
st.markdown("""
    <div style='text-align: center; padding: 1rem 0;'>
        <img src='https://raw.githubusercontent.com/ResiliLytics/ResiliLytics-assets/main/Logo%20.png' alt='ResiliLytics Logo' width='300'>
    </div>
...
if page == "Home":
    st.markdown("""
    <h2 style='text-align: center; color: #ffffff;'>ResiliLytics Dashboard</h2>
    <h4 style='text-align: center; color: #bbbbbb;'>Sourcing Intelligence for Resilient Supply Chains</h4>
    <div style='background: #0e1117; padding: 1rem; border-radius: 8px; color: #ccc;'>
        <p>ResiliLytics is a free next-generation platform designed to help Small and Medium Enterprises (SMEs) monitor and improve supply chain resilience using intelligent risk-to-action insights.</p>
        <p><strong>Powered by data and guided by insight, ResiliLytics:</strong></p>
        <ul>
            <li>Analyzes supplier risk exposure.</li>
            <li>Recommends mitigation strategies.</li>
            <li>Translates supply chain complexity into clear, actionable plans.</li>
        </ul>
        ...
        <p>All in one simple, accessible tool — created for real-world SME challenges.</p>
        <p><strong>🧪 Original Contribution</strong></p>
        <ul>
            <li>Supply chain visualization</li>
            <li>Dynamic diversification metrics</li>
            <li>End-to-end data-to-action transformation — not previously available in one open-access interface.</li>
        </ul>
        <p>The platform is developed in support of ongoing academic and professional research on improving SME supply-chain resilience through intelligent systems.</p>
        <a href='#about-full' style='color:#91caff;'>Read more</a>
    </div>
    """, unsafe_allow_html=True)
...
# ---- PAGE: DASHBOARD ----
    ...
    if uploaded_file:
        ...
        with st.expander("Click to preview dashboard sample"):
...
<div style='font-size: 0.85rem; color: #aaa; padding: 1rem 0;'>
    ...
    <br><br>
    This application <strong>does not offer paid services</strong> and <strong>is not affiliated with any business entity</strong>. Data uploaded is processed temporarily and not stored.
</div>
""", unsafe_allow_html=True)
