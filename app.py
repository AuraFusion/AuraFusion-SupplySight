...
if uploaded_file:
    ...
    st.markdown("""
<div style='background-color: #ffffff; color: #91caff; display: inline-block; padding: 8px 14px; border-radius: 6px; font-size: 1.5rem;'> Please upload a file to view dynamic metrics</div>""", unsafe_allow_html=True)
