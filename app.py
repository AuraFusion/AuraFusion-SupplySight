...
<div style='color:#ccc; font-size:0.95rem;'>
    ...
    <a href='https://yourdomain.com/sample_template.xlsx' style='color:#91caff;'>Download Sample Template</a>
</div>
""", unsafe_allow_html=True)
st.markdown("---")
...
if uploaded_file:
    ...
    # Define thresholds
    resilience_score = 100 - top_supplier_pct - (avg_volatility * 10)
    ...
    # Bottom content could stay as-is or display preview table if needed
