...
if "submitted" in query_params:
    st.success("✅ Message received! We’ll get back to you shortly.")

contact_form = """
<form action="https://formspree.io/f/xrbnaeqd" method="POST" onsubmit="location.href='/?submitted=true'; return true;">
    <label>Your email:<br>
        <input type="email" name="email" placeholder="you@example.com" style="width: 100%; padding: 8px;" required>
    </label><br><br>

    <label>Your message:<br>
        <textarea name="message" placeholder="Write your message here..." rows="5" style="width: 100%; padding: 8px;" required></textarea>
    </label><br>
