...
if uploaded_file:
    ...
    st.markdown("""
<div style='background-color: #0d1117; color: #ffffff; display: inline-block; padding: 8px 14px; border-radius: 6px; font-size: 1.1rem;'> Please upload a file to view dynamic metrics.</div>""", unsafe_allow_html=True)
