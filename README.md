...
Just go to the **Contact** tab in the app and fill the form — your message will be sent directly to the project team via [Formspree.io](https://formspree.io).

> 🛡️ To improve spam protection, honeypot fields and Google reCAPTCHA are enabled on the form. You can manage them in your [Formspree dashboard](https://dashboard.formspree.io).
